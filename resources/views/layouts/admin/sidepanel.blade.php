...
<div role="tabpanel" class="sidepanel">
    ...
    <div class="tab-content">
        ...
        <div role="tabpanel" class="tab-pane" id="chat">
            ...
            <ul class="group">
                <li class="member"><a href="#"><img src={{ asset('admin/img/profileimg5.png') }} alt="img"><b>Allice Mingham</b>Los Angeles</a><span class="status offline"></span></li>
                <li class="member"><a href="#"><img src={{ asset('admin/img/profileimg6.png') }} alt="img"><b>James Throwing</b>Las Vegas</a><span class="status offline"></span></li>
            </ul>
